...
plot_configs = [
    {
        "title": "IID",
        "files": {
            "No Noise": "/scratch/wd04/sm0074/fl_privacy/logs/15aug/csv/non/qnli_Iid.csv",
            "Fixed Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csvFx/qnli_Iid_ep17.csv",
            "Dynamic Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csv/qnli_Iid.csv",
        }
    },
    {
        "title": "Linear",
        "files": {
            "No Noise": "/scratch/wd04/sm0074/fl_privacy/logs/15aug/csv/non/qnli_Linear.csv",
            "Fixed Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csvFx/qnli_Linear_ep17.csv",
            "Dynamic Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csv/qnli_Linear.csv",
        }
    },
    {
        "title": "Square",
        "files": {
            "No Noise": "/scratch/wd04/sm0074/fl_privacy/logs/15aug/csv/non/qnli_Square.csv",
            "Fixed Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csvFx/qnli_Square_ep17.csv",
            "Dynamic Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csv/qnli_Square.csv",
        }
    },
    {
        "title": "Exp",
        "files": {
            "No Noise": "/scratch/wd04/sm0074/fl_privacy/logs/15aug/csv/non/qnli_Exp.csv",
            "Fixed Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csvFx/qnli_Exp_ep17.csv",
            "Dynamic Noise": "/scratch/wd04/sm0074/fl_privacy/logs/16aug/csv/qnli_Exp_.csv",
        }
    }
]
...
plt.savefig("./tables/plot/accuracy_round_qnli.png")
plt.show()
